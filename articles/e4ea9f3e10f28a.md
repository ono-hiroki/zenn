---
title: "FastAPI × OpenAI ストリームで“ピロピロ”出力するAPIを作ってみた"
emoji: "🎃"
...
「ピロピロ」と一文字ずつ流れるような UI を実現したいとき、OpenAI API のストリーミング機能を使うと、サーバーからクライアントへリアルタイムにトークンを渡せます。FastAPI
ならシンプルに実装できるらしいのでやってみました。
...
いまさら感もありますが、次はRAGでもやってみようかなと思います。
